      ...
      <div className={styles.rightPanel}>
        <div className={styles.loginCard}>
          ...
          <Button 
            ...
            style={{ width: '100%', padding: '1rem', marginTop: '1.5rem', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.75rem' }}
          >
            <svg viewBox="0 0 24 24" className={styles.googleIcon} style={{ width: '24px', height: '24px' }}>
